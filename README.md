...
- [lukeautry/tsoa](https://github.com/lukeautry/tsoa) ([v4.0.0-rc.1](https://github.com/lukeautry/tsoa/releases/tag/v4.0.0-rc.1), 2 weeks ago) - Build OpenAPI-compliant REST APIs using TypeScript and Node
- [grahamplata/charts](https://github.com/grahamplata/charts) ([raw-0.2.3](https://github.com/grahamplata/charts/releases/tag/raw-0.2.3), 1 month ago) - Helm charts managed by grahamplata
