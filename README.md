...
- [lukeautry/tsoa](https://github.com/lukeautry/tsoa) ([v5.0.0-alpha.2](https://github.com/lukeautry/tsoa/releases/tag/v5.0.0-alpha.2), 3 weeks ago) - Build OpenAPI-compliant REST APIs using TypeScript and Node
